"""
URL configuration for Severnay_Pchela project.
...
from history.views import HistoryGuestView
...
urlpatterns = [
    ...
    path("guest/<int:pk>/history", HistoryGuestView.as_view(), name="guest_history"),
]
